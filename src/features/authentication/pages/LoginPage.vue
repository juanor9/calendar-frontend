  ...
  <div class="login-page">
    <div class="login-page__container">
      ...
      <div class="login-page__header">
        <img src="@/assets/images/vana-logo.png" alt="Vana Calendar" class="login-page__logo" />
      ...
      <div class="login-page__form">
        ...
        <div
          v-if="loginMessage"
          :class="['login-page__message', `login-page__message--${loginMessage.type}`]"
          role="alert"
          aria-live="polite"
        >
        ...
        <div class="login-page__features">
          <h3 class="login-page__features-title">¿Por qué elegir Vana Calendar?</h3>
...
<style lang="scss" scoped>
  ...
  .login-page {
    ...
    &::before {
      ...
      position: absolute;
      inset: 0;
      background: radial-gradient(circle at 30% 20%, rgba($brand-primary, 0.05) 0%, transparent 50%),
        radial-gradient(circle at 70% 80%, rgba($accent-happy, 0.03) 0%, transparent 50%);
      pointer-events: none;
    }
