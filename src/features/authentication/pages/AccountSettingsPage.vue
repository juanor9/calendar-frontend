...
import ProfileEditCard from '@/features/authentication/components/ProfileEditCard/ProfileEditCard.vue'
import SecurityDashboardCard from '@/features/authentication/components/SecurityDashboardCard/SecurityDashboardCard.vue'
import DataExportCard from '@/features/authentication/components/DataExportCard/DataExportCard.vue'
import BaseModal from '@/shared/ui/BaseModal/BaseModal.vue'
import ArrowLeftIcon from '@/shared/icons/ArrowLeftIcon.vue'
import ExclamationTriangleIcon from '@/shared/icons/ExclamationTriangleIcon.vue'
