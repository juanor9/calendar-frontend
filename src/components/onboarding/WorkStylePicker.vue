  ...
  <div class="work-style-picker">
    <div class="picker-header">
      ...
      <p class="picker-description">
        We'll use this to optimize your calendar and suggest the best times for different activities.
      </p>
    </div>
    ...
    <div class="style-options">
      <button
        ...
        :class="[
          'style-card',
          { 'style-card--selected': selectedStyle === style.id }
        ]"
    ...
    <BaseModal
      ...
      title="Customize Your Work Style"
      class="custom-modal"
    >
      <div class="custom-form">
        ...
        <div class="form-group">
          ...
          <div class="checkbox-group">
            <label v-for="breakPref in breakPreferences" :key="breakPref.value" class="checkbox-option">
              <input
                v-model="customStyle.breaks"
                type="checkbox"
                :value="breakPref.value"
              />
