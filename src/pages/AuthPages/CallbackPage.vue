    ...
    <div class="callback-container">
      <div class="callback-content">
        ...
        <div class="progress-dots">
          <div v-for="i in 3" :key="i" class="dot" :class="{ active: currentStep >= i }"></div>
        </div>
        ...
        <div v-if="error" class="error-section">
          <div class="error-content">
            ...
            <div class="error-actions">
              <button class="retry-button" @click="retryAuthentication">Try Again</button>
...
<script setup lang="ts">
  ...
  const processCallback = async () => {
    try {
      ...
      error.value = err instanceof Error ? err : new Error('Unknown callback error')
