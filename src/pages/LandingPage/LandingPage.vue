  ...
  <div class="landing-page">
    ...
    <section class="hero-section">
      <div class="hero-container">
        ...
        <div class="hero-cta">
          <RegisterButton size="large" width="full" class="hero-cta-button">
            <template #iconLeft>
              <SparklesIcon />
            </template>
    ...
    <section class="social-proof-section">
      <div class="container">
        ...
        <CompanyLogos class="company-logos" />
    ...
    <section class="cta-section">
      <div class="container">
        <div class="cta-content">
          ...
          <RegisterButton size="large" class="cta-button"> Get Started Free </RegisterButton>
        </div>
      </div>
    </section>
  </div>
...
<script setup lang="ts">
  ...
  import CompanyLogos from '@/components/landing/CompanyLogos.vue'
